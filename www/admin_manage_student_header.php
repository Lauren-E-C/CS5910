    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin: 10px;">
        ...
        <nav class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li>
                    <a href="admin_manage_student_grid.php" class="btn btn-success my-2 my-sm-0">Back</a>
                </li>
            </ul>
        </nav>
    </nav>
...
// $_SERVER['SCRIPT_URL']
$manage_links = array(
        'admin_manage_student_register.php' => 'Register Class',
        'admin_manage_student_drop.php' => 'Drop Class',
        'admin_manage_student_grade.php' => 'Change Grade',
        'admin_manage_student_schedule.php' => 'Schedule',
        'admin_manage_student_transcript.php' => 'Transcript',
        'admin_manage_student_audit.php' => 'Audit',
        'admin_manage_student_viewhold.php' => 'Hold'
);
